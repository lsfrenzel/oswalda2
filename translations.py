...
TRANSLATIONS = {
    'pt': {
        ...
        'team_media_name': 'Camila Dantas',
        'team_media_title': 'Media Buyer',
    ...
    'en': {
        ...
        'team_media_name': 'Camila Dantas',
        'team_media_title': 'Media Buyer',
        'team_media_desc': 'Assists in planning, negotiating, and executing media buying strategies across various platforms to optimize advertising investments. Focuses on digital and traditional media channels, working closely with senior media buyers and marketing teams.',
        'team_operations_name': 'Roberto de Jesus',
    ...
    'team_media_name': 'Camila Dantas',
    'team_media_title': 'Acheteuse Média',
    'team_media_desc': 'Aide à la planification, à la négociation et à l\'exécution de stratégies d\'achat média sur diverses plateformes pour optimiser les investissements publicitaires. Se concentre sur les canaux médias numériques et traditionnels, travaillant en étroite collaboration avec les acheteurs médias seniors et les équipes marketing.',
    'team_operations_name': 'Roberto de Jesus',
